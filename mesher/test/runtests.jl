...
# !!! Main.UserApp is configured as an alias for Main.Mesher and you might encounter it in some tests
using Main.Mesher, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Mesher tests" begin
  @includetests ARGS
end
